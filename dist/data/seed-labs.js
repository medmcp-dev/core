export const labValues = [
    {
        ...
        clinical_notes: "Symptoms of hyponatraemia correlate with rate of onset more than absolute level. Acute (<48h) severe hyponatraemia with neurological symptoms: treat urgently with hypertonic saline (3% NaCl). Always calculate plasma osmolality and urine Na/osmolality to guide diagnosis.",
    },
    {
        name: "potassium",
        abbreviation: "K+",
    ...
    },
    {
        ...
        clinical_notes: "Chloride is rarely the primary diagnostic target but is essential for calculating anion gap and serum osmolality. In the context of normal saline administration, hyperchloraemic acidosis can mimic other acid-base disorders.",
    },
    {
        name: "urea",
        abbreviation: "BUN",
        ...
        clinical_notes: "UK labs report urea in mmol/L; US labs report BUN (blood urea nitrogen) in mg/dL. Conversion: BUN (mg/dL) × 0.357 = urea (mmol/L). Urea:creatinine ratio useful for localising cause of AKI. Symptoms of uraemia: nausea, vomiting, encephalopathy, pericarditis, pruritus — occur at very high levels or with rapid rise.",
    },
    {
        name: "creatinine",
        abbreviation: "Cr",
    ...
    },
    {
        ...
        clinical_notes: "HbA1c reflects average glucose over ~3 months (red cell lifespan). Target HbA1c: generally <48 mmol/mol (6.5%) for T2DM on non-hypoglycaemic agents; <53 mmol/mol (7%) if on insulin/sulfonylureas. Critical hypoglycaemia (<3.0): IV glucose 10% or 50% dextrose, or glucagon IM if IV access not possible. Note: bedside glucometers inaccurate in extreme ranges (<2.0 or >25 mmol/L) — confirm with lab sample.",
    },
    {
        name: "troponin I",
        abbreviation: "hs-TnI",
        ...
        clinical_notes: "Threshold values vary by assay (hs-TnI vs hs-TnT) and manufacturer. Always interpret in clinical context. A static troponin elevation without significant delta (rise/fall pattern) suggests chronic elevation (CKD, stable HF, LBBB) rather than acute myocardial injury. Troponin T (hs-TnT) 99th percentile is typically ~19 ng/L (varies by assay). In suspected MI with diagnostic ECG: do not delay reperfusion for troponin result.",
    },
    {
    ...
    },
    {
        ...
        clinical_notes: "Iron deficiency anaemia: ↓ferritin (<15 µg/L diagnostic), ↓iron, ↑TIBC, microcytic hypochromic. Reticulocyte count: ↑in haemolysis and haemorrhage (regenerative), ↓in bone marrow failure, B12/folate deficiency (hypo-regenerative). Hb electrophoresis for haemoglobinopathies. Anaemia of chronic disease: ↑ferritin, ↓iron, ↓TIBC, normocytic (but can be microcytic). Critical Hb <70: symptoms at rest — severe fatigue, tachycardia, angina, heart failure.",
    },
    {
        ...
        clinical_notes: "Neutropenia (<2.0 ×10⁹/L) = risk of bacterial and fungal infections. Febrile neutropenia: temp >38°C + neutrophils <0.5 — medical emergency, start IV antibiotics (Tazocin) within 1h after cultures. Critical WBC <2.0: notify clinician immediately. Reactive leucocytosis (leukaemoid reaction, >30) vs leukaemia: check differential, blood film (blasts?), LDH, uric acid. Clozapine and carbimazole require mandatory WBC monitoring due to agranulocytosis risk.",
    },
];
//# sourceMappingURL=seed-labs.js.map